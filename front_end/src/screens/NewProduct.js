            ...
            <Paper className={classes.productInfo}>
              <div style={{ flex: 3, justifyContent: 'center', alignItems: 'center', paddingLeft: 15, paddingTop: 10 }}>
                ...
                <label htmlFor='input-image' style={{ alignItems: 'center', justifyContent: 'center' }} >
                  <img src={this.state.subImage.name ? URL.createObjectURL(this.state.subImage) : 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTfR8X74rkrhWpxqkeNUjMR71RTB2tLljU_-TlBXdPJ9qhJzcLWPA'} alt='default avatar' />
