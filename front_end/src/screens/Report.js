                            ...
                            {this.props.top_5_employee.map((employee,index) => (
                                <div>
                                    <div style = {{display: 'flex', flexDirection: 'row'}}>
                                        ...
                                        <div style = {{flex:2,  display: 'flex', justifyContent: 'center', alignItems:'center', fontWeight:'bold', color:employee.user_id[0].role == 'admin' ? 'red' : employee.user_id[0].role == 'manager' ? 'blue' : 'green'}}>{employee.user_id[0].role == 'admin' ? 'Quản lý' : employee.user_id[0].role == 'manager' ? 'Quản lý' : 'Nhân viên bán hàng'}</div>
